...
<a class='button blue' href='http://skyserver.sdss.org/dr7/en/tools/chart/navi.asp?ra=<?php echo $row['ra'] ?>&dec=<?php echo $row['decl'] ?>&opt=G' target="_blank">Sloan Navigate</a>
